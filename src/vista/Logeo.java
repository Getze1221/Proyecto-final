...
public class Logeo extends javax.swing.JFrame {
    ...
    //Se crean variables para los usuarios
    private Usuario admin;
    private ValidacionUsuario validacionUsuario;

    public Logeo() {
        initComponents();
        this.setSize(517, 637); //Dimensiones de la ventana
        this.setResizable(false);

        this.admin = new Usuario();
        // Llenar datos de los usuarios
        this.admin.setNombre("admin");
        this.admin.setContraseña("admin");
        this.admin.setTipo("admin");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resouser/Iconos/usuario.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resouser/Iconos/contrasena.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resouser/Iconos/restaurante_1.png"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resouser/Iconos/curriculum.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //Botón cancelar para salir del programa
        System.exit(0);
